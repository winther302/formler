...
def help():
    ...
    print("ki_avg skriv \"formler ki_avg 6.61 0.95 1400 \" hvor 1. tal er gennemsnit, 2. er standardafvigelse og 3. er n\n")
    print("n_andele skriv \"formler n_andele 0.043 1.96 0.022\" hvor 1. tal er andel , 2. tal er interval og 3. tal er fejlmargin")
